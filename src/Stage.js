...
export default class Stage {
    ...
    initScene() {
        const {isMobile: t, globeRadius: e = 25, mobileRadius, autoRotationSpeed, draggingRotationSpeed} = bl;
        // console.log(bl)
        this.radius = t && mobileRadius && mobileRadius > 0 ? mobileRadius : e,
        ...
        // 发光光源
        const s = new THREE.Mesh(new THREE.SphereBufferGeometry(this.radius, 45, 45), new THREE.ShaderMaterial({
            uniforms: {
                c: {
                    type: "f",
                    value: .7
